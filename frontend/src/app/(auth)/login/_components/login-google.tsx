...
export function GoogleLogin() {
  ...
  return (
    <Link href={`${API_URL}/continuegoogle`}>
      <button className="flex items-center justify-center shadow-sm gap-5 w-full rounded-xl py-2 px-4 mt-4 text-slate-800 hover:bg-blue-300 hover:cursor-pointer transition-colors duration-500 active:bg-amber-800">
        <svg
